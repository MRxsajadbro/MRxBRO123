...
Owner     =  'MRx_Sajad-BRO'
Facebook   =  'Facebook.com/MRx Sajad jafari
Telegram     =  '@AMiR_ALi1500 
...
▇▇◣◥▅▅▅◤◢▇▇
▇▇▇◣╲▇╱◢▇▇▇                   
\033[0;96m╔══\033[0;97m[•] Authur      \033[0;96m╔══\033[0;97m[•] MRx_Sajad-BRO 
\033[0;96m╠══\033[0;97m[•] Facebook  \033[0;96m╠══\033[0;97m[•] MRx Sajad BRO
\033[0;96m╚══\033[0;97m[•] MYBest,freinds\033[0;96m╚══\033[0;97m[•] @MRxNOor
          
       \033[47m\033[1;31m MRx \033[41m\033[1;37m X  SajadBRO \x1b[0m\n
""")
## DATE TIME
skrng = datetime.now()
tahun = skrng.year
...
def mkdir_data_login():
	# Owner
    try:os.mkdir("Original Written By MRx Sajad BRO")
    except:pass
    # Joke
...
def MRxBRO():
    ...
    print(f"{B}[0] Out ")
    MRxBRO123 = input(f"{P}\n   Choose : {B}")
    if MRxBRO123 in ["0","00"]:
        exit()
    elif MRxBRO123 in ["1","01"]:
    	os.system("clear");banner()
    	mk1()
    else:print(f'{M}  Roung Input !!');os.system('xdg-open https://www.facebook.com/MRx Sajad jafari')
...
def fii_xd():
	MRxBRO()
	MRxBRO =input(f"{P}   Choose : {P}")
	if MRxBRO in [""]:
		print(f"{B}[*]{M} Roung Input !!");os.system('xdg-open https://www.facebook.com/MRx Sajad jafari')
	elif MRxBRO in ["1","01"]:
		print(f"{B} \n \033[0;96m[✓] Want Start Crack {P}Y/t")
		_start_=input(f"{P}\n   Choose : {P}")
		if _start_ in ["t","T"]:
			print(f"{B}   \n{M} Ok Godby !!");os.system('xdg-open https://www.facebook.com/MRx Sajad jafari')
			...
			ter =input(f"{P}\n   Choose : {P}")
			if ter in ["m","M"]:
				print(f"{B}   \n{M} Only Support default-Pass !!");os.system('xdg-open https://www.facebook.com/MRx Sajad jafari')
				exit()
			elif ter in ["d","D"]:
